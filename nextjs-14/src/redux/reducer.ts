...
import issueReducer from "@/app/components/issue/service/issue-slice";
...
export const issuePersistConfig = {
  key: "issue",
  storage,
  whitelist: ["issueState"],
};
...
const persistedIssueReducer = persistReducer(issuePersistConfig, issueReducer);
