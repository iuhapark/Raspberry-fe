...
export default function AuthPage() {
  ...
  return (
    <div className="flex justify-center h-screen w-full px-5 sm:px-0">
      <div className="mt-28 w-[73vh] h-[67vh] flex justify-center items-center shadow-none">
        <div className="w-4/5 p-[8.5vh]">
          <div>
            {" "}
            <button
              onClick={()=> window.location.href = `http://localhost:8000/oauth2/authorization/google`}
              className="AuthButton btn btn-sm btn-success active flex px-5 justify-center w-full py-4 bg-none"
              role="button"
              style={{ backgroundColor: "var(--background)" }}
            >
              <div className="flex px-5 justify-center w-full py-4">
                ...
                <div className="flex w-full justify-center">
                  <h1 className="light:text-gray-700 dark:text-white whitespace-nowrap text-[15px]">
                    contine with google
                  </h1>
                </div>
              </div>
            ...
            <button
              onClick={()=> window.location.href = `${PG.USER}/login`}
              className="AuthButton btn btn-sm btn-success active flex px-5 justify-center w-full py-4 bg-none"
              role="button"
              style={{ backgroundColor: "var(--background)" }}
            >
