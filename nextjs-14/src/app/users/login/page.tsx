...
export default function LoginPage() {
  ...
  return (
    <div className="flex justify-center h-screen w-full px-5 sm:px-0">
      <div
        className="mt-28 w-[73vh] h-[67vh] flex rounded-[3.5vh] shadow-2xl overflow-hidden"
        ...
        <div className="w-full p-[8.5vh] justify-center items-center">
          ...
          <div className="flex justify-center">
            <button
              ...
              className="static m-11 text-white shadow-md hover:bg-gray-100 bg-black w-36 rounded-3xl"
            >
              Login
            </button>
          </div>
